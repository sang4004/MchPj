<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-text>
            <String label="MchCd" v-model="value.mchCd" :editMode="editMode"/>
            <String label="MchNm" v-model="value.mchNm" :editMode="editMode"/>
            <String label="MchMd" v-model="value.mchMd" :editMode="editMode"/>
            <String label="MchSize" v-model="value.mchSize" :editMode="editMode"/>
        </v-card-text>
