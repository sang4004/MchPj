<template>
    <div style="max-height:80vh;">
        ...
        >
            <wj-flex-grid-filter :filterColumns="['mchCd','mchNm','mchMd','mchSize',]" />
            <wj-flex-grid-column binding="index" header="Number" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="mchCd" header="mchCd" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="mchNm" header="mchNm" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="mchMd" header="mchMd" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="mchSize" header="mchSize" width="2*" :isReadOnly="true" align="center" />
        </wj-flex-grid>
